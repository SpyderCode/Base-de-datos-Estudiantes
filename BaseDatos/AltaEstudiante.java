...
public class AltaEstudiante extends JInternalFrame implements ActionListener{
	...
	public AltaEstudiante(String titulo, boolean tamaño, 
		...
		CmbxCarrera.setModel(new DefaultComboBoxModel(new String[] {"Sistemas Computacionales", "Gestion Empresarial", "Arquitectura", "Electromec\u00E1nica", "Materiales", "Industrial", "Informatica", "Administracion"}));
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==btnDarDeAlta) {
			...
			Estudiante estudiantex=new Estudiante(NoCtrlx,nombrex,sexox,horariox);
		...
		if (e.getSource()==btnCancelar) {estudiantex=null;this.dispose();}
