...
public class altaHorario extends JInternalFrame {
	...
	public altaHorario(String titulo, boolean tamaño, boolean cerrar, boolean maximizar, Tecnologico padre) {
		...
		comboBoxHoraMat.setModel(new DefaultComboBoxModel(
				new String[] { "7:00-8:00", "8:00-9:00", "9:00-10:00", "10:00-11:00", "12:00-13:00", "13:00-14:00" }));
		...
		comboBoxHorarioTarde.setModel(new DefaultComboBoxModel(new String[] { "12:00-13:00", "13:00-14:00",
				"14:00-15:00", "16:00-17:00", "17:00-18:00", "18:00-19:00" }));
